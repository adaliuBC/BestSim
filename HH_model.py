...
def HH(C = 1., g_Na = 120., g_K = 36., g_leak = 0.03, 
       E_Na = 50., E_K = -77., E_leak = -54.387, V_th = 20.,
...
stim = const_input(5., simu_time, ts)
# list of input, change with different input waveform
HH(C = C, g_Na = g_Na, g_K = g_K, g_leak = g_leak, 
   E_Na = E_Na, E_K = E_K, E_leak = E_leak, V_th = V_th,
